const CACHE='civilized-men-v3';
const ASSETS=['/','/index.html','/manifest.webmanifest','/assets/icons/icon.svg','/assets/css/main.css','/assets/js/products.js','/assets/js/app.js'];
